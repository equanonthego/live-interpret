> 이 프로젝트는 Google의 오픈소스 예제 [gemini-live-translate-livekit](https://github.com/google-gemini/gemini-live-translate-livekit) (Apache-2.0, commit e30ffc9)를 기반으로 하며, 한국어 강의 동시통역용으로 커스터마이징했습니다 (기본 청취 언어 4개 프리셋 등).
